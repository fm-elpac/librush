...
- <https://gitlink.org.cn/fm-elpac/librush>

---

艾刷 (libRush = lib + IBus + Rust + h): 用 rust 编写的 ibus 模块, 不用 GObject
...
ibus 输入法框架使用 C 语言和 GObject 编写, 并不方便在 rust 编程语言之中使用.
于是又造了这个轮子. (狗头)

The ibus input method framework is written in C and GObject. This project is
created for easy use of ibus in rust.
...
Please contribute (issue, PR, etc.) at the main platform (github). The mirrors
can be ignored.
...
This repository is released under: `LGPL-2.1-or-later` or `GPL-3.0-or-later`, at
your option.
